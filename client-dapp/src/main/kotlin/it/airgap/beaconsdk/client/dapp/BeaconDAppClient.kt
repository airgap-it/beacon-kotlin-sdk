...
public class BeaconDAppClient internal constructor(
...
): BeaconDAppClient = BeaconDAppClient.Builder(name, storage, secureStorage, clientId).apply(builderAction).build()
...
public class P2pMatrix internal constructor(
     ...
     *
     * @property [storagePlugin] An external implementation of [P2pMatrixStoragePlugin].
    ...
    public class Factory internal constructor(
        private val storagePlugin: P2pMatrixStoragePlugin,
...
/**
 * Creates a new instance of [P2pMatrix.Factory] configured with [storagePlugin] and optional [matrixNodes] and [httpClientProvider].
 */

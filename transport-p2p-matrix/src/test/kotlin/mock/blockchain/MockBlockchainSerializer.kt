...
import mock.blockchain.message.MockError
import mock.blockchain.message.V1MockBlockchainBeaconMessage
import mock.blockchain.message.V1MockPermissionBeaconRequest
import mock.blockchain.message.V1MockPermissionBeaconResponse
import mock.blockchain.message.V2MockBlockchainBeaconMessage
import mock.blockchain.message.V2MockPermissionBeaconRequest
import mock.blockchain.message.V2MockPermissionBeaconResponse
import mock.blockchain.message.V3MockBlockchainBeaconRequestData
import mock.blockchain.message.V3MockBlockchainBeaconResponseData
import mock.blockchain.message.V3MockPermissionBeaconRequestData
import mock.blockchain.message.V3MockPermissionBeaconResponseData
import mock.data.MockAppMetadata
import mock.data.MockNetwork
import mock.data.MockPermission

internal class MockBlockchainSerializer : Blockchain.Serializer {
    ...
    override val v1: V1BeaconMessageBlockchainSerializer = object : V1BeaconMessageBlockchainSerializer {
        override val message: KSerializer<V1BeaconMessage> = object : KJsonSerializer<V1BeaconMessage> {
            ...
            override fun serialize(jsonEncoder: JsonEncoder, value: V1BeaconMessage) {
                when (value) {
                    is V1MockPermissionBeaconRequest -> jsonEncoder.encodeSerializableValue(
                        V1MockPermissionBeaconRequest.serializer(), value)
                    is V1MockPermissionBeaconResponse -> jsonEncoder.encodeSerializableValue(
                        V1MockPermissionBeaconResponse.serializer(), value)
                    is V1MockBlockchainBeaconMessage -> jsonEncoder.encodeSerializableValue(
                        V1MockBlockchainBeaconMessage.serializer(), value)
        ...
        override val message: KSerializer<V2BeaconMessage> =
            object : KJsonSerializer<V2BeaconMessage> {
                ...
                override fun serialize(jsonEncoder: JsonEncoder, value: V2BeaconMessage) {
                    when (value) {
                        is V2MockPermissionBeaconRequest -> jsonEncoder.encodeSerializableValue(
                            V2MockPermissionBeaconRequest.serializer(), value)
                        is V2MockPermissionBeaconResponse -> jsonEncoder.encodeSerializableValue(
                            V2MockPermissionBeaconResponse.serializer(), value)
                        is V2MockBlockchainBeaconMessage -> jsonEncoder.encodeSerializableValue(
                            V2MockBlockchainBeaconMessage.serializer(), value)
                        else -> failWithIllegalArgument()
                    }
                }
            }

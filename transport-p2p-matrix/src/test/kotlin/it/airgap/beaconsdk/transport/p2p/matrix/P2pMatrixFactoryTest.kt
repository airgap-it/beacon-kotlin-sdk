...
internal class P2pMatrixFactoryTest {
    ...
    fun `creates P2pMatrix instance with custom nodes`() {
        ...
        val factory = P2pMatrix.Factory(matrixNodes = nodes, storagePlugin = MockP2pMatrixStoragePlugin())
        val p2pMatrix = factory.create(dependencyRegistry)
    ...
    fun `creates P2pMatrix instance with custom HttpProvider`() {
        ...
        val factory = P2pMatrix.Factory(httpClientProvider = httpClientProvider, storagePlugin = MockP2pMatrixStoragePlugin())
        val p2pMatrix = factory.create(dependencyRegistry)

 ...
 */
public class BeaconWalletClient internal constructor(
    ...
    ) : InitBuilderWithBaseStorage<BeaconWalletClient, Builder>(name, BeaconScope(clientId), storage, secureStorage) {
...
): BeaconWalletClient = BeaconWalletClient.Builder(name, storage, secureStorage, clientId).apply(builderAction).build()
